            ...
            <template #names>
              ...
              >
                <base-button
                  ...
                  base-color="white"
                >
                  <span class="shipping-btn__limoo-title shipping-btn-title">ارسال توسط لیمو</span>
                </base-button>
              </li>
              <li
              ...
              >
                <base-button
                  ...
                  base-color="white"
                >
                  <span class="shipping-btn__seller-title shipping-btn-title">ارسال توسط فروشنده</span>
                </base-button>
              </li>
              <li
              ...
              >
                <base-button
                  ...
                  base-color="white"
                >
                     <span class="shipping-btn__post-title shipping-btn-title">ارسال پستی</span>
                </base-button>
              </li>
