...
const state = () => ({
  ...
  commentsData: [
    ...
    },
    {
      ...
      Title: "آیفون بی نظیر ",
      Body:
        "یه گوشی فوق العاده عالی اپل جواب خودش رو پس داده گوشی خیلی خوب و روونیه بخاطر پردازنده قویش کلا اپل فوق العادست تنها ایرادش باتریشه که روزی یک و نیم بار تقریبا باید شارژ بشه نتلی تنبلس  نتقلن خهتثق متلس منتتلس منتنت لسم نت لست ت لستنتنتتنتلس نتنتنتس نتسللتنتس نتسنتلنت شلنتنتنست قتلثهت متلستنتقثل هتسل تسل",
      Rate: 3.2,
      Suggest: 1,
      buyerBadge:false,
    },
